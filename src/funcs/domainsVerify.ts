...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.VerifyDomainRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/domains/{id}/verify")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DomainVerificationStatus$inboundSchema),
